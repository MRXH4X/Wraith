...
window._i18n.hu = {
  ...
  'agents.wraith_process_tip':    'Fut: a fő asszisztens mindig a --channels session-ben fut. Ez a kártya fixen Fut állapotot mutat, nincs per-ágens tmux-ellenőrzés.',
  'agents.wraith_channel_tip':    'Online: a fő asszisztens csatornáját a --channels session kezeli, ezért fixen online (nincs külön token-ellenőrzés).',
  ...
  'agents.toast.wraith_restarted': '{bot} channels újraindítva',
  ...
  'onboarding.identity.saved_restart_failed': 'A név elmentve, de az ügynök újraindítása nem sikerült. Indítsd újra kézzel (Linux: systemctl --user restart wraith-channels), aztán térj vissza ide.',
  'onboarding.identity.saved_restart_needed': 'Név elmentve. A futó ügynök a következő újraindításakor veszi fel az új nevet.',
  'onboarding.title':            'Wraith beállítása',
  ...
  'onboarding.step1.saved_restart_failed': 'A token elmentve, de az ügynök újraindítása nem sikerült. Indítsd újra kézzel (Linux: systemctl --user restart wraith-channels), aztán térj vissza ide.',
  ...
  'auth.devices.revoke_ssh_warning': 'Az eszközkulcs visszavonva, de az SSH-bejegyzést nem sikerült törölni -- az eszköz az alagutat még ki tudja nyitni. Töröld kézzel az ~/.ssh/authorized_keys megfelelő wraith-remote sorát (részletek: docs/dashboard-auth-recovery.md).',

  'auth.bridge.title':             'Bridge-párosítás',
  'auth.bridge.desc':              'Illeszd be a Bridge alkalmazásban megjelenő kulcs-sort (ssh-ed25519 ... wraith-remote:...), adj nevet az eszköznek, és a kapott csomagot másold vissza a Bridge-be. Az eszköz saját, külön visszavonható kulcsot kap.',
  'auth.bridge.key_placeholder':   'ssh-ed25519 ... wraith-remote:...',
