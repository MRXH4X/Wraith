...
[![GitHub stars](https://img.shields.io/github/stars/MRXH4X/wraith?style=social)](https://github.com/MRXH4X/wraith)
...
```powershell
irm https://raw.githubusercontent.com/MRXH4X/wraith/main/install-windows.ps1 | iex
```
...
> ```bash
> cd ~ && curl -fsSL https://raw.githubusercontent.com/MRXH4X/wraith/main/install-linux.sh -o install.sh && bash install.sh
> ```
...
A Wraith több külső projektre és koncepcióra épül. A teljes felsorolás (forrás, szerző, licensz, hogyan használjuk) az [ATTRIBUTIONS.md](./ATTRIBUTIONS.md) fájlban található. Köszönet a Perplexity AI-nek (Bumblebee), Artem Zhutovnak (handoff / retrospective / skill-management skill suite), Mike Van Hornnak (printing-press), Andrej Karpathynak (CLAUDE.md pattern), és Matt Pococknak (handoff design tippek) a munkájukért.

## Készítette

**MRXH4X**

[![GitHub](https://img.shields.io/github/stars/MRXH4X/wraith?style=social)](https://github.com/MRXH4X/wraith)
